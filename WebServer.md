# WebServer- 飞牛 OS 可视化网页配置工具

WebServer是一款专为飞牛 NAS 系统 (fnOS) 设计的轻量级可视化 Web 环境配置与管理工具。它通过直观的 Web 界面，帮助用户轻松管理 Nginx、PHP、数据库以及网站站点，无需繁琐的命令行操作。
...
2.  **访问**：在飞牛桌面点击 **WebServer** 图标打开管理界面。
3.  **初始化**：
    *   进入“系统环境”页面。
