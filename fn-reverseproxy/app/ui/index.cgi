...
BASE_PATH="/var/apps/fn-reverseproxy/target/www"
BACKEND_HOST="${BACKEND_HOST:-127.0.0.1}"
BACKEND_PORT="${BACKEND_PORT:-16601}"
BACKEND_UNIX_SOCKET="${BACKEND_UNIX_SOCKET:-${TRIM_PKGVAR:-/var/apps/fn-reverseproxy/var}/reverseproxy.sock}"
