...
BASE_PATH="${TRIM_APPDEST:-/usr/local/apps/@appcenter/appcenterThirdParty}/www"
BACKEND_UNIX_SOCKET="${BACKEND_UNIX_SOCKET:-${TRIM_PKGVAR:-/usr/local/apps/@appdata/appcenterThirdParty}/appcenter.sock}"
