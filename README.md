...
| 图标 | 应用名称 | 版本 | 平台 | 大小 | 描述 |
| :---: | :--- | :--- | :--- | :--- | :--- |
| <img src="https://github.com/Brian099/fn_fpk_packages/raw/main/fn-ApacheManager/ICON.PNG" width="48" height="48"> | ApacheManager | v1.0.1 | all | 4.65 MB | Apache 独立生命周期管理器。提供环境检测、一键安装、服务控制及实时日志。 |
...
| <img src="https://github.com/Brian099/fn_fpk_packages/raw/main/fn-appcenterThirdParty/ICON.PNG" width="48" height="48"> | appcenterThirdParty | v1.0.102 | all | 7.47 MB | <p>应用精选，用于管理和安装第三方飞牛应用。</p><p>功能特性：</p><ul><li>浏览和搜索第三方应用</li><li>支持多源管理，类似群晖套件中心</li><li>自动发现本地源目录</li><li>应用下载和安装</li></ul> |
...
| <img src="https://github.com/Brian099/fn_fpk_packages/raw/main/fn-notepad/ICON.PNG" width="48" height="48"> | notepad | v1.0.2 | all | 8.34 MB | <p>便签记事本是一款简约记事本应用。</p><ul><li>支持毛玻璃质感，美观大方</li><li>支持颜色分类，快速记录</li><li>支持按日期管理备忘事项</li></ul> |
...
| <img src="https://github.com/Brian099/fn_fpk_packages/raw/main/fn-phpmyadmin/ICON.PNG" width="48" height="48"> | phpMyAdmin | v1.0.4 | all | 70.64 MB | phpMyAdmin 是一款功能强大的 MySQL / MariaDB 数据库 Web 管理工具，提供直观的图形界面进行数据库管理、SQL 查询、数据导入导出等操作。安装后即可通过浏览器轻松管理您的 MariaDB 数据库。 |
| <img src="https://github.com/Brian099/fn_fpk_packages/raw/main/fn-reverseproxy/ICON.PNG" width="48" height="48"> | fn-reverseproxy | v1.0.5 | all | 7.18 MB | 轻量级反向代理管理工具，专为飞牛 OS 设计。无需占用额外 TCP 端口，通过 Unix Socket 安全通信。&lt;br&gt;&lt;strong&gt;核心功能&lt;/strong&gt;&lt;br&gt;• 域名路由：按域名自动将请求分发到后端服务&lt;br&gt;• 多端口监听：同一应用支持 HTTP/HTTPS 多端口同时运行&lt;br&gt;• SSL/TLS 证书自动发现：从飞牛 OS 证书管理中按域名智能匹配&lt;br&gt;• 通配符证书支持（如 *.example.com）&lt;br&gt;• SNI 多域名同一端口复用&lt;br&gt;• 动态规则管理：Web 界面添加/编辑/删除规则，保存即生效&lt;br&gt;• 规则校验：名称唯一性、端口冲突检测，前后端双重校验&lt;br&gt;&lt;strong&gt;使用说明&lt;/strong&gt;&lt;br&gt;1. 安装后在桌面打开应用进入管理界面&lt;br&gt;2. 在「系统设置 → 证书管理」中预先添加您的域名 SSL 证书&lt;br&gt;3. 添加代理规则时填写来源（协议/端口/域名）和目标地址即可 |
| <img src="https://github.com/Brian099/fn_fpk_packages/raw/main/fn-scheduledtask/ICON.PNG" width="48" height="48"> | fn-scheduledtask | v1.0.2 | all | 0.12 MB | <p>计划任务管理应用，支持 Cron 表达式、间隔执行、指定时间执行以及开机/关机事件触发。</p><p>可创建 Python 函数任务和 Shell 脚本任务，满足自动化运维需求。</p> |
...
![](https://img.shields.io/github/downloads/Brian099/fn_fpk_packages/2026.04.23-1543/total)
