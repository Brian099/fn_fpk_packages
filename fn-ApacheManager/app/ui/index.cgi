...
if [[ "$REL_PATH" == /api/* ]]; then
    ...
    ACTION=""
    case "$REL_PATH" in
        "/api/apache/status")     ACTION="status" ;;
        "/api/apache/install")    ACTION="install" ;;
        "/api/apache/start")      ACTION="start" ;;
        "/api/apache/stop")       ACTION="stop" ;;
        "/api/apache/restart")    ACTION="restart" ;;
        "/api/apache/reload")     ACTION="reload" ;;
        "/api/apache/check")      ACTION="check" ;;
        "/api/apache/logs")       ACTION="logs" ;;
    esac
