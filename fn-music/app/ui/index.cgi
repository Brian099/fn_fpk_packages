...
BASE_PATH="/usr/local/apps/@appcenter/musicplayer/www"
...
if [[ $REL_PATH == /api* ]]; then
  BACKEND_UNIX_SOCKET="${BACKEND_UNIX_SOCKET:-${MUSICPLAYER_UNIX_SOCKET:-/usr/local/apps/@appdata/musicplayer/app.sock}}"
