...
BASE_PATH="$(cd "$SCRIPT_DIR/../www" 2>/dev/null && pwd || echo "/usr/local/apps/@appcenter/notepad/www")"
...
BACKEND_UNIX_SOCKET="${BACKEND_UNIX_SOCKET:-${TRIM_PKGVAR}/notepad.sock}"
